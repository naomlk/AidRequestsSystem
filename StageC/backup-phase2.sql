...
ALTER TABLE public.availability OWNER TO "EfratElisheva";
...
ALTER TABLE public.call OWNER TO "EfratElisheva";
...
ALTER TABLE public.catagory OWNER TO "EfratElisheva";
...
ALTER TABLE public.scheduled OWNER TO "EfratElisheva";
...
ALTER TABLE public.skill OWNER TO "EfratElisheva";
...
ALTER TABLE public.skill_category OWNER TO "EfratElisheva";
...
ALTER TABLE public.training OWNER TO "EfratElisheva";
...
ALTER TABLE public.type OWNER TO "EfratElisheva";
...
ALTER TABLE public.volunteer OWNER TO "EfratElisheva";
...
ALTER TABLE public.volunteer_call OWNER TO "EfratElisheva";
...
ALTER TABLE public.volunteer_skill OWNER TO "EfratElisheva";
...
CREATE TABLE public.volunteer_training (
    training_id integer NOT NULL,
    volunteer_id integer NOT NULL
);


ALTER TABLE public.volunteer_training OWNER TO "EfratElisheva";
...
COPY public.availability (day_of_week, start_time, end_time, preferred_region_, volunteer_id) FROM stdin;
\.
...
COPY public.call (longitude, call_time, status, call_id, phone, call_date, latitude, description, type_id) FROM stdin;
...
COPY public.catagory (catagory_id, catagory_name) FROM stdin;
1	Language
2	Vehicle
3	Locksmith
4	Rescue
...
COPY public.scheduled (meeting_date, start_time, location, end_time, training_id) FROM stdin;
\.
...
COPY public.skill (skill_id, description, requires_certificate, difficulty_level, skill_name) FROM stdin;
...
COPY public.skill_category (skill_id, catagory_id) FROM stdin;
\.
...
COPY public.training (training_name, description_, max_participant, duration_hours, training_id) FROM stdin;
...
COPY public.volunteer (first_name, phone, birthday, email, city, volunteer_id, recruitment_date, last_name, is_active) FROM stdin;
...
COPY public.volunteer_call (volunteer_id, call_id) FROM stdin;
3	3
6	6
12	12
12	20
...
COPY public.volunteer_skill (volunteer_id, skill_id) FROM stdin;
3	5
6	6
12	12
16	1
...
COPY public.volunteer_training (training_id, volunteer_id) FROM stdin;
3	3
4	3
6	6
7	6
...
ALTER TABLE ONLY public.volunteer_training
...
CREATE INDEX idx_call_type_id ON public.call USING btree (type_id);
...
CREATE INDEX idx_volunteer_call_volunteer_id ON public.volunteer_call USING btree (volunteer_id);
...
CREATE INDEX idx_volunteer_is_active ON public.volunteer USING btree (is_active);
...
ALTER TABLE ONLY public.availability
    ADD CONSTRAINT availability_volunteer_id_fkey FOREIGN KEY (volunteer_id) REFERENCES public.volunteer(volunteer_id);
...
ALTER TABLE ONLY public.call
    ADD CONSTRAINT call_type_id_fkey FOREIGN KEY (type_id) REFERENCES public.type(type_id);
...
ALTER TABLE ONLY public.scheduled
    ADD CONSTRAINT scheduled_training_id_fkey FOREIGN KEY (training_id) REFERENCES public.training(training_id);
...
ALTER TABLE ONLY public.skill_category
    ADD CONSTRAINT skill_category_catagory_id_fkey FOREIGN KEY (catagory_id) REFERENCES public.catagory(catagory_id);
...
ALTER TABLE ONLY public.skill_category
    ADD CONSTRAINT skill_category_skill_id_fkey FOREIGN KEY (skill_id) REFERENCES public.skill(skill_id);
...
ALTER TABLE ONLY public.volunteer_call
    ADD CONSTRAINT volunteer_call_call_id_fkey FOREIGN KEY (call_id) REFERENCES public.call(call_id);
...
ALTER TABLE ONLY public.volunteer_call
    ADD CONSTRAINT volunteer_call_volunteer_id_fkey FOREIGN KEY (volunteer_id) REFERENCES public.volunteer(volunteer_id);
...
ALTER TABLE ONLY public.volunteer_skill
    ADD CONSTRAINT volunteer_skill_skill_id_fkey FOREIGN KEY (skill_id) REFERENCES public.skill(skill_id);
...
ALTER TABLE ONLY public.volunteer_skill
    ADD CONSTRAINT volunteer_skill_volunteer_id_fkey FOREIGN KEY (volunteer_id) REFERENCES public.volunteer(volunteer_id);
...
ALTER TABLE ONLY public.volunteer_training
    ADD CONSTRAINT volunteer_training_training_id_fkey FOREIGN KEY (training_id) REFERENCES public.training(training_id);
...
ALTER TABLE ONLY public.volunteer_training
    ADD CONSTRAINT volunteer_training_volunteer_id_fkey FOREIGN KEY (volunteer_id) REFERENCES public.volunteer(volunteer_id);
