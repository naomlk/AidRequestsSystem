...
BEGIN
    ...
    IF NEW.completion_time IS NOT NULL AND OLD.completion_time IS DISTINCT FROM NEW.completion_time THEN
...
--OLD représente la ligne avant le UPDATE.
-- NEW représente la ligne après le UPDATE.